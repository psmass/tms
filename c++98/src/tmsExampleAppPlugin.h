...
namespace tms {
    ...
    * ---------------------------------------------------------------------------- */
    ...
    CircuitContinuityPluginSupport_print_data(
        const CircuitContinuity *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    ClockMonotonicPersistenceTypePluginSupport_print_data(
        const ClockMonotonicPersistenceType *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    DesiredCircuitContinuityPluginSupport_print_data(
        const DesiredCircuitContinuity *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    EnergyStartStopLevelPluginSupport_print_data(
        const EnergyStartStopLevel *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    GroundFaultDetectionPluginSupport_print_data(
        const GroundFaultDetection *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    GroundingDesignTypePluginSupport_print_data(
        const GroundingDesignType *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    OperatorPriorityTypePluginSupport_print_data(
        const OperatorPriorityType *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    OperatorIntentTypePluginSupport_print_data(
        const OperatorIntentType *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PowerConnectionDetectionTypePluginSupport_print_data(
        const PowerConnectionDetectionType *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PowerConnectorPolarityPluginSupport_print_data(
        const PowerConnectorPolarity *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PowerConnectorTypePluginSupport_print_data(
        const PowerConnectorType *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PowerPortDirectionalityPluginSupport_print_data(
        const PowerPortDirectionality *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PowerConnectorFeaturePluginSupport_print_data(
        const PowerConnectorFeature *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PowerSwitchFeaturePluginSupport_print_data(
        const PowerSwitchFeature *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PowerSwitchReasonPluginSupport_print_data(
        const PowerSwitchReason *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    DistributionFeaturePluginSupport_print_data(
        const DistributionFeature *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    ConversionFeaturePluginSupport_print_data(
        const ConversionFeature *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    MicrogridDashboardFeaturePluginSupport_print_data(
        const MicrogridDashboardFeature *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    MicrogridControllerFeaturePluginSupport_print_data(
        const MicrogridControllerFeature *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    FailureModeIndicatorPluginSupport_print_data(
        const FailureModeIndicator *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    EngineOperatingStatePluginSupport_print_data(
        const EngineOperatingState *sample,
        const char *desc,
        unsigned int indent_level);
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PowerSwitchTransitionCodePluginSupport_print_data(
        const PowerSwitchTransitionCode *sample,
        const char *desc,
        unsigned int indent_level);
